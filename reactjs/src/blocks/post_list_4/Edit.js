...
class Edit extends Component {
    ...
    render() {
        ...
        if (blockId) { CssGenerator(this.props.attributes, 'post-list-4', blockId); }
        return (
            <Fragment>
                <InspectorControls>
                    <Sections>
                        <Section slug="design" title={__('Design')}>
                            <Layout 
                                ...
                                data={[{ type:'layout', block:'post-list-4', key:'layout', pro: true, options: [
                                    { icon: icons.pl4layout1, label: __('Layout 1'), value: 'layout1', pro: false },
                                    { icon: icons.pl4layout2, label: __('Layout 2'), value: 'layout2', pro: true },
                                    { icon: icons.pl4layout3, label: __('Layout 3'), value: 'layout3', pro: true },
                                    { icon: icons.pl4layout4, label: __('Layout 4'), value: 'layout4', pro: true },
                                ]}]}/>
                        ...
                        <Section slug="setting" title={__('Setting')}>
                            <GeneralContent store={store} 
                                ...
                                include={[
                                    { position: 1, data:{ type:'range',key:'largeHeight', min:0, max:800, step:1, unit:true, responsive:true, label:'Large Height', pro: true, customClass: 'ultp-pro-field' } },
                                    { position: 2, data:{ type:'range',key:'spaceLargeItem', min:0, max:100, step:1, unit:true, responsive:true, label:'Large Space', pro: true, customClass: 'ultp-pro-field' } },
                                    { data:{ type:'toggle',key:'imgFlip', label:'Image Flip', pro: true, customClass: 'ultp-pro-field' } }, 
                            ...
                            { paginationShow && <PaginationContent pro={true} store={store} /> }
