...
class Edit extends Component {
    ...
    renderContent(){
        ...
        return(
            !error ? !loading ? postsList.length > 0 ?
                <div className={ `ultp-block-items-wrap ultp-block-post-module1 ultp-block-content-${varticalAlign} ultp-block-content-${columnFlip} ultp-${layout}` }>
                    ...
                    { ( postsList.map( (post, idx) => {
                     ...
                     <div className="ultp-big-post-module1">{bigBlock}</div>
                     <div className="ultp-small-post-module1">{smallBlock}</div>
                </div>
    ...
    render() {
        ...
        if (blockId) { CssGenerator(this.props.attributes, 'post-module-1', blockId); }
        return (
            <Fragment>
                <InspectorControls>
                    <Sections>
                        <Section slug="design" title={__('Design')}>
                            <Layout 
                                ...
                                data={[{ type:'layout', block:'post-module-1', key:'layout', pro: true, options: [
                                    { icon: icons.pm1layout1, label: __('Layout 1'), value: 'layout1', pro: false },
                                    { icon: icons.pm1layout2, label: __('Layout 2'), value: 'layout2', pro: true },
                                    { icon: icons.pm1layout3, label: __('Layout 3'), value: 'layout3', pro: true },
                                    { icon: icons.pm1layout4, label: __('Layout 4'), value: 'layout4', pro: true },
                                    { icon: icons.pm1layout5, label: __('Layout 5'), value: 'layout5', pro: true }
                                ]}]}/>
                        ...
                        <Section slug="setting" title={__('Setting')}>
                            <GeneralContent store={store} 
                                ...
                                include={[
                                    ...
                                    { data:{ type:'select',key:'varticalAlign',label:'Small Vertical Align', options:[{value:'top',label:'Top'},{value:'middle',label:'Middle'},{value:'bottom',label:'Bottom'}]}},  
