...
class Edit extends Component {
    ...
    renderContent(){
        ...
        return(
            !error ? !loading ? postsList.length > 0 ?
                <div className={ `ultp-block-items-wrap ultp-block-row ultp-${layout}` }>
    ...
    render() {
        ...
        if (blockId) { CssGenerator(this.props.attributes, 'post-grid-7', blockId); }
        return (
            <Fragment>
                <InspectorControls>
                    <Sections>
                        <Section slug="design" title={__('Design')}>
                            <Layout 
                                ...
                                data={[{ type:'layout', block:'post-grid-7', key:'layout', pro: true, options: [
                                    { icon: icons.pg7layout1, label: __('Layout 1'), value: 'layout1', pro: false },
                                    { icon: icons.pg7layout2, label: __('Layout 2'), value: 'layout2', pro: true },
                                    { icon: icons.pg7layout3, label: __('Layout 3'), value: 'layout3', pro: true },
                                ]}]}/>
                        ...
                        <Section slug="setting" title={__('Setting')}>
                            <GeneralContent store={store} 
                                ...
                                include={[
                                    ...
                                    { position: 2, data:{ type:'range',key:'overlayHeight', min:0, max:800, step:1, unit:true, responsive:true, label:'Height', pro: true, customClass: 'ultp-pro-field' } },
