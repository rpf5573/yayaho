...
class Edit extends Component {
    ...
    renderContent(){
        ...
        const { excerptLimit, showSmallMeta, metaStyle, metaShow, catShow, showImage, metaSeparator, titleShow, catStyle, catPosition, titlePosition, excerptShow , imgAnimation, imgOverlayType, imgOverlay, metaList, metaListSmall, showSmallCat, readMore, readMoreText, readMoreIcon, overlayContentPosition, showSmallBtn, showSmallExcerpt, metaPosition, showFullExcerpt, layout, columnFlip, titleAnimation, customCatColor, onlyCatColor } = this.props.attributes;
        return(
    ...
    render() {
        ...
        if (blockId) { CssGenerator(this.props.attributes, 'post-grid-5', blockId); }
        return (
            <Fragment>
                <InspectorControls>
                    <Sections>
                        <Section slug="design" title={__('Design')}>
                            <Layout 
                                ...
                                data={[{ type:'layout', block:'post-grid-5', key:'layout', pro: true, options: [
                                    { icon: icons.pg5layout1, label: __('Layout 1'), value: 'layout1', pro: false },
                                    { icon: icons.pg5layout2, label: __('Layout 2'), value: 'layout2', pro: true },
                                ]}]}/>
                        ...
                        <Section slug="setting" title={__('Setting')}>
                            <GeneralContent store={store} 
                                ...
                                include={[
                                    ...
                                    { data:{ type:'toggle',key:'columnFlip', customClass: 'ultp-pro-field', pro: true, label:'Flip' } }, 
