<div class="ultp-content-wrap">
    <div class="ultp-helps-items">
        <div class="ultp-helps-item ultp-admin-card">
            ...
            <a class="ultp-btn ultp-btn-transparent" target="_blank" href="https://docs.wpxpo.com/gutenberg-post-blocks/system-requirements/"><?php esc_html_e('Documentation', 'ultimate-post');?></a>
        </div>
        <div class="ultp-helps-item ultp-admin-card">
        ...
        <div class="ultp-helps-item ultp-admin-card">
            ...
            <a class="ultp-btn ultp-btn-transparent" target="_blank" href="https://www.wpxpo.com/contact/?utm_campaign=go_premium"><?php esc_html_e('Submit a Ticket »', 'ultimate-post');?></a>
        </div>
    </div>
</div><!--/helps-->